...
var Config_campo_pesquisaDadosDetailsComponent = (function () {
    ...
    Config_campo_pesquisaDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.config_campo_pesquisa.Config_campo_pesquisa"; var id = +params['id']; _this.config_campo_pesquisa = new Config_campo_pesquisa_1.Config_campo_pesquisa(); _this.config_campo_pesquisa.cd_config_campo_pesquisa = id; o.objetoJson = _this.config_campo_pesquisa; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    Config_campo_pesquisaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'config_campo_pesquisa-dados-details', templateUrl: 'config_campo_pesquisa_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Config_campo_pesquisaDadosDetailsComponent);
    return Config_campo_pesquisaDadosDetailsComponent;
}());
exports.Config_campo_pesquisaDadosDetailsComponent = Config_campo_pesquisaDadosDetailsComponent;
//# sourceMappingURL=config_campo_pesquisa_dadosDetails.component.js.map