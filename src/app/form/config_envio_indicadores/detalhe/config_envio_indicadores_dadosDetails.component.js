...
var Config_envio_indicadoresDadosDetailsComponent = (function () {
    ...
    Config_envio_indicadoresDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'config_envio_indicadores-dados-details', templateUrl: 'config_envio_indicadores_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Config_envio_indicadoresDadosDetailsComponent);
    return Config_envio_indicadoresDadosDetailsComponent;
}());
exports.Config_envio_indicadoresDadosDetailsComponent = Config_envio_indicadoresDadosDetailsComponent;
//# sourceMappingURL=config_envio_indicadores_dadosDetails.component.js.map