...
var PeriodicidadeDadosDetailsComponent = (function () {
    ...
    PeriodicidadeDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.periodicidade.Periodicidade"; var id = +params['id']; _this.periodicidade = new Periodicidade_1.Periodicidade(); _this.periodicidade.cd_periodicidade = id; o.objetoJson = _this.periodicidade; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    PeriodicidadeDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'periodicidade-dados-details', templateUrl: 'periodicidade_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], PeriodicidadeDadosDetailsComponent);
    return PeriodicidadeDadosDetailsComponent;
}());
exports.PeriodicidadeDadosDetailsComponent = PeriodicidadeDadosDetailsComponent;
//# sourceMappingURL=periodicidade_dadosDetails.component.js.map