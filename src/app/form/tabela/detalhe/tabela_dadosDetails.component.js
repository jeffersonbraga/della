...
var TabelaDadosDetailsComponent = (function () {
    ...
    TabelaDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.tabela.Tabela"; var id = +params['id']; _this.tabela = new Tabela_1.Tabela(); _this.tabela.cd_tabela = id; o.objetoJson = _this.tabela; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    TabelaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'tabela-dados-details', templateUrl: 'tabela_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], TabelaDadosDetailsComponent);
    return TabelaDadosDetailsComponent;
}());
exports.TabelaDadosDetailsComponent = TabelaDadosDetailsComponent;
//# sourceMappingURL=tabela_dadosDetails.component.js.map