...
var Treinamento_funcaoDadosDetailsComponent = (function () {
    ...
    Treinamento_funcaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'treinamento_funcao-dados-details', templateUrl: 'treinamento_funcao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Treinamento_funcaoDadosDetailsComponent);
    return Treinamento_funcaoDadosDetailsComponent;
}());
exports.Treinamento_funcaoDadosDetailsComponent = Treinamento_funcaoDadosDetailsComponent;
//# sourceMappingURL=treinamento_funcao_dadosDetails.component.js.map