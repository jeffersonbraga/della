...
var Executar_reuniaoDadosDetailsComponent = (function () {
    ...
    Executar_reuniaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'executar_reuniao-dados-details', templateUrl: 'executar_reuniao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Executar_reuniaoDadosDetailsComponent);
    return Executar_reuniaoDadosDetailsComponent;
}());
exports.Executar_reuniaoDadosDetailsComponent = Executar_reuniaoDadosDetailsComponent;
//# sourceMappingURL=executar_reuniao_dadosDetails.component.js.map