...
var EstadoDadosDetailsComponent = (function () {
    ...
    EstadoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'estado-dados-details', templateUrl: 'estado_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], EstadoDadosDetailsComponent);
    return EstadoDadosDetailsComponent;
}());
exports.EstadoDadosDetailsComponent = EstadoDadosDetailsComponent;
//# sourceMappingURL=estado_dadosDetails.component.js.map