...
var Config_pesquisaDadosEditComponent = (function () {
    ...
    Config_pesquisaDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'config_pesquisa-dados-edit', templateUrl: 'config_pesquisa_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Config_pesquisaDadosEditComponent);
    return Config_pesquisaDadosEditComponent;
}());
exports.Config_pesquisaDadosEditComponent = Config_pesquisaDadosEditComponent;
//# sourceMappingURL=config_pesquisa_dadosEdit.component.js.map