...
var Config_pesquisaDadosComponent = (function () {
    ...
    Config_pesquisaDadosComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'config_pesquisa-dados', templateUrl: 'config_pesquisa_dados.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router])
    ], Config_pesquisaDadosComponent);
    return Config_pesquisaDadosComponent;
}());
exports.Config_pesquisaDadosComponent = Config_pesquisaDadosComponent;
...
//# sourceMappingURL=config_pesquisa_dados.component.js.map