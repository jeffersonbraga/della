...
var Natureza_ocorrenciaDadosDetailsComponent = (function () {
    ...
    Natureza_ocorrenciaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'natureza_ocorrencia-dados-details', templateUrl: 'natureza_ocorrencia_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Natureza_ocorrenciaDadosDetailsComponent);
    return Natureza_ocorrenciaDadosDetailsComponent;
}());
exports.Natureza_ocorrenciaDadosDetailsComponent = Natureza_ocorrenciaDadosDetailsComponent;
//# sourceMappingURL=natureza_ocorrencia_dadosDetails.component.js.map