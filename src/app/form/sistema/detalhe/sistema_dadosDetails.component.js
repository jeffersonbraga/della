...
var SistemaDadosDetailsComponent = (function () {
    ...
    SistemaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'sistema-dados-details', templateUrl: 'sistema_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], SistemaDadosDetailsComponent);
    return SistemaDadosDetailsComponent;
}());
exports.SistemaDadosDetailsComponent = SistemaDadosDetailsComponent;
//# sourceMappingURL=sistema_dadosDetails.component.js.map