...
var PaisDadosEditComponent = (function () {
    ...
    PaisDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'pais-dados-edit', templateUrl: 'pais_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], PaisDadosEditComponent);
    return PaisDadosEditComponent;
}());
exports.PaisDadosEditComponent = PaisDadosEditComponent;
//# sourceMappingURL=pais_dadosEdit.component.js.map