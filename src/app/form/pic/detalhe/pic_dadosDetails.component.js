...
var PicDadosDetailsComponent = (function () {
    ...
    PicDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.pic.Pic"; var id = +params['id']; _this.pic = new Pic_1.Pic(); _this.pic.cd_pic = id; o.objetoJson = _this.pic; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    PicDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'pic-dados-details', templateUrl: 'pic_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], PicDadosDetailsComponent);
    return PicDadosDetailsComponent;
}());
exports.PicDadosDetailsComponent = PicDadosDetailsComponent;
//# sourceMappingURL=pic_dadosDetails.component.js.map