...
var Ponto_mapaDadosEditComponent = (function () {
    ...
    Ponto_mapaDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'ponto_mapa-dados-edit', templateUrl: 'ponto_mapa_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Ponto_mapaDadosEditComponent);
    return Ponto_mapaDadosEditComponent;
}());
exports.Ponto_mapaDadosEditComponent = Ponto_mapaDadosEditComponent;
//# sourceMappingURL=ponto_mapa_dadosEdit.component.js.map