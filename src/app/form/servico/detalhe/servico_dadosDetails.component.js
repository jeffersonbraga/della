...
var ServicoDadosDetailsComponent = (function () {
    ...
    ServicoDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.servico.Servico"; var id = +params['id']; _this.servico = new Servico_1.Servico(); _this.servico.cd_servico = id; o.objetoJson = _this.servico; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    ServicoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'servico-dados-details', templateUrl: 'servico_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], ServicoDadosDetailsComponent);
    return ServicoDadosDetailsComponent;
}());
exports.ServicoDadosDetailsComponent = ServicoDadosDetailsComponent;
//# sourceMappingURL=servico_dadosDetails.component.js.map