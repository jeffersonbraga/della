...
var Operacao_notificacaoDadosDetailsComponent = (function () {
    ...
    Operacao_notificacaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'operacao_notificacao-dados-details', templateUrl: 'operacao_notificacao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Operacao_notificacaoDadosDetailsComponent);
    return Operacao_notificacaoDadosDetailsComponent;
}());
exports.Operacao_notificacaoDadosDetailsComponent = Operacao_notificacaoDadosDetailsComponent;
//# sourceMappingURL=operacao_notificacao_dadosDetails.component.js.map