...
var Descritivo_treinamentoDadosDetailsComponent = (function () {
    ...
    Descritivo_treinamentoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'descritivo_treinamento-dados-details', templateUrl: 'descritivo_treinamento_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Descritivo_treinamentoDadosDetailsComponent);
    return Descritivo_treinamentoDadosDetailsComponent;
}());
exports.Descritivo_treinamentoDadosDetailsComponent = Descritivo_treinamentoDadosDetailsComponent;
//# sourceMappingURL=descritivo_treinamento_dadosDetails.component.js.map