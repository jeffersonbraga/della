...
var Evento_campanhaDadosDetailsComponent = (function () {
    ...
    Evento_campanhaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'evento_campanha-dados-details', templateUrl: 'evento_campanha_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Evento_campanhaDadosDetailsComponent);
    return Evento_campanhaDadosDetailsComponent;
}());
exports.Evento_campanhaDadosDetailsComponent = Evento_campanhaDadosDetailsComponent;
//# sourceMappingURL=evento_campanha_dadosDetails.component.js.map