...
var Exame_funcaoDadosDetailsComponent = (function () {
    ...
    Exame_funcaoDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.exame_funcao.Exame_funcao"; var id = +params['id']; _this.exame_funcao = new Exame_funcao_1.Exame_funcao(); _this.exame_funcao.cd_exame_funcao = id; o.objetoJson = _this.exame_funcao; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    Exame_funcaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'exame_funcao-dados-details', templateUrl: 'exame_funcao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Exame_funcaoDadosDetailsComponent);
    return Exame_funcaoDadosDetailsComponent;
}());
exports.Exame_funcaoDadosDetailsComponent = Exame_funcaoDadosDetailsComponent;
//# sourceMappingURL=exame_funcao_dadosDetails.component.js.map