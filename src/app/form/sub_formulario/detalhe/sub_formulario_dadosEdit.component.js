...
var Sub_formularioDadosEditComponent = (function () {
    ...
    Sub_formularioDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'sub_formulario-dados-edit', templateUrl: 'sub_formulario_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Sub_formularioDadosEditComponent);
    return Sub_formularioDadosEditComponent;
}());
exports.Sub_formularioDadosEditComponent = Sub_formularioDadosEditComponent;
//# sourceMappingURL=sub_formulario_dadosEdit.component.js.map