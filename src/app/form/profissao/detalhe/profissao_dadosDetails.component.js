...
var ProfissaoDadosDetailsComponent = (function () {
    ...
    ProfissaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'profissao-dados-details', templateUrl: 'profissao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], ProfissaoDadosDetailsComponent);
    return ProfissaoDadosDetailsComponent;
}());
exports.ProfissaoDadosDetailsComponent = ProfissaoDadosDetailsComponent;
//# sourceMappingURL=profissao_dadosDetails.component.js.map