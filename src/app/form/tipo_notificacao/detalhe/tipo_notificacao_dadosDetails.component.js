...
var Tipo_notificacaoDadosDetailsComponent = (function () {
    ...
    Tipo_notificacaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'tipo_notificacao-dados-details', templateUrl: 'tipo_notificacao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Tipo_notificacaoDadosDetailsComponent);
    return Tipo_notificacaoDadosDetailsComponent;
}());
exports.Tipo_notificacaoDadosDetailsComponent = Tipo_notificacaoDadosDetailsComponent;
//# sourceMappingURL=tipo_notificacao_dadosDetails.component.js.map