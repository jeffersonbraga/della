...
var CondicaoDadosEditComponent = (function () {
    ...
    CondicaoDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'condicao-dados-edit', templateUrl: 'condicao_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], CondicaoDadosEditComponent);
    return CondicaoDadosEditComponent;
}());
exports.CondicaoDadosEditComponent = CondicaoDadosEditComponent;
//# sourceMappingURL=condicao_dadosEdit.component.js.map