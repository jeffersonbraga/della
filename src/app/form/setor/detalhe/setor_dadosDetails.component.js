...
var SetorDadosDetailsComponent = (function () {
    ...
    SetorDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'setor-dados-details', templateUrl: 'setor_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], SetorDadosDetailsComponent);
    return SetorDadosDetailsComponent;
}());
exports.SetorDadosDetailsComponent = SetorDadosDetailsComponent;
//# sourceMappingURL=setor_dadosDetails.component.js.map