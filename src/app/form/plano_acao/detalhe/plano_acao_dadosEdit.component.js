...
var Plano_acaoDadosEditComponent = (function () {
    ...
    Plano_acaoDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'plano_acao-dados-edit', templateUrl: 'plano_acao_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Plano_acaoDadosEditComponent);
    return Plano_acaoDadosEditComponent;
}());
exports.Plano_acaoDadosEditComponent = Plano_acaoDadosEditComponent;
//# sourceMappingURL=plano_acao_dadosEdit.component.js.map