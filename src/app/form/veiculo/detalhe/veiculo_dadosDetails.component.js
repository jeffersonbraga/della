...
var VeiculoDadosDetailsComponent = (function () {
    ...
    VeiculoDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.veiculo.Veiculo"; var id = +params['id']; _this.veiculo = new Veiculo_1.Veiculo(); _this.veiculo.cd_veiculo = id; o.objetoJson = _this.veiculo; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    VeiculoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'veiculo-dados-details', templateUrl: 'veiculo_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], VeiculoDadosDetailsComponent);
    return VeiculoDadosDetailsComponent;
}());
exports.VeiculoDadosDetailsComponent = VeiculoDadosDetailsComponent;
//# sourceMappingURL=veiculo_dadosDetails.component.js.map