...
var Mapa_formularioDadosDetailsComponent = (function () {
    ...
    Mapa_formularioDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.mapa_formulario.Mapa_formulario"; var id = +params['id']; _this.mapa_formulario = new Mapa_formulario_1.Mapa_formulario(); _this.mapa_formulario.cd_mapa_formulario = id; o.objetoJson = _this.mapa_formulario; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    Mapa_formularioDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'mapa_formulario-dados-details', templateUrl: 'mapa_formulario_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Mapa_formularioDadosDetailsComponent);
    return Mapa_formularioDadosDetailsComponent;
}());
exports.Mapa_formularioDadosDetailsComponent = Mapa_formularioDadosDetailsComponent;
//# sourceMappingURL=mapa_formulario_dadosDetails.component.js.map