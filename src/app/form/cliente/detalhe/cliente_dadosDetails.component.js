...
var ClienteDadosDetailsComponent = (function () {
    ...
    ClienteDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'cliente-dados-details', templateUrl: 'cliente_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], ClienteDadosDetailsComponent);
    return ClienteDadosDetailsComponent;
}());
exports.ClienteDadosDetailsComponent = ClienteDadosDetailsComponent;
//# sourceMappingURL=cliente_dadosDetails.component.js.map