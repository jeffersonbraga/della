...
var UsuarioDadosDetailsComponent = (function () {
    ...
    UsuarioDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'usuario-dados-details', templateUrl: 'usuario_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], UsuarioDadosDetailsComponent);
    return UsuarioDadosDetailsComponent;
}());
exports.UsuarioDadosDetailsComponent = UsuarioDadosDetailsComponent;
//# sourceMappingURL=usuario_dadosDetails.component.js.map