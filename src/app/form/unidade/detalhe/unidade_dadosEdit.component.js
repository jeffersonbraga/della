...
var UnidadeDadosEditComponent = (function () {
    ...
    UnidadeDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'unidade-dados-edit', templateUrl: 'unidade_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], UnidadeDadosEditComponent);
    return UnidadeDadosEditComponent;
}());
exports.UnidadeDadosEditComponent = UnidadeDadosEditComponent;
//# sourceMappingURL=unidade_dadosEdit.component.js.map