...
var Config_campo_formularioDadosDetailsComponent = (function () {
    ...
    Config_campo_formularioDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'config_campo_formulario-dados-details', templateUrl: 'config_campo_formulario_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Config_campo_formularioDadosDetailsComponent);
    return Config_campo_formularioDadosDetailsComponent;
}());
exports.Config_campo_formularioDadosDetailsComponent = Config_campo_formularioDadosDetailsComponent;
//# sourceMappingURL=config_campo_formulario_dadosDetails.component.js.map