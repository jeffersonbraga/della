...
var Categoria_ocorrenciaDadosDetailsComponent = (function () {
    ...
    Categoria_ocorrenciaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'categoria_ocorrencia-dados-details', templateUrl: 'categoria_ocorrencia_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Categoria_ocorrenciaDadosDetailsComponent);
    return Categoria_ocorrenciaDadosDetailsComponent;
}());
exports.Categoria_ocorrenciaDadosDetailsComponent = Categoria_ocorrenciaDadosDetailsComponent;
//# sourceMappingURL=categoria_ocorrencia_dadosDetails.component.js.map