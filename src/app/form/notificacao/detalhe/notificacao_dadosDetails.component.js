...
var NotificacaoDadosDetailsComponent = (function () {
    ...
    NotificacaoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'notificacao-dados-details', templateUrl: 'notificacao_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], NotificacaoDadosDetailsComponent);
    return NotificacaoDadosDetailsComponent;
}());
exports.NotificacaoDadosDetailsComponent = NotificacaoDadosDetailsComponent;
//# sourceMappingURL=notificacao_dadosDetails.component.js.map