...
var OcorrenciaDadosDetailsComponent = (function () {
    ...
    OcorrenciaDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'ocorrencia-dados-details', templateUrl: 'ocorrencia_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], OcorrenciaDadosDetailsComponent);
    return OcorrenciaDadosDetailsComponent;
}());
exports.OcorrenciaDadosDetailsComponent = OcorrenciaDadosDetailsComponent;
//# sourceMappingURL=ocorrencia_dadosDetails.component.js.map