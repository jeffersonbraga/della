...
var EquipamentoDadosDetailsComponent = (function () {
    ...
    EquipamentoDadosDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.parent.params.subscribe(function (params) { var o = new ObjetoVirtual_1.ObjetoVirtual(); o.classeJava = "br.com.primum.modelo.equipamento.Equipamento"; var id = +params['id']; _this.equipamento = new Equipamento_1.Equipamento(); _this.equipamento.cd_equipamento = id; o.objetoJson = _this.equipamento; _this.pesquisaService.efetuarPesquisa(o).subscribe(function (result) { return _this.onEfetuarPesquisa(result); }, function (error) { return _this.errorMessage = error; }); });
    };
    ...
    EquipamentoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'equipamento-dados-details', templateUrl: 'equipamento_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], EquipamentoDadosDetailsComponent);
    return EquipamentoDadosDetailsComponent;
}());
exports.EquipamentoDadosDetailsComponent = EquipamentoDadosDetailsComponent;
//# sourceMappingURL=equipamento_dadosDetails.component.js.map