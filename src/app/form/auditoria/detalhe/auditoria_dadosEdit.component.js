...
var AuditoriaDadosEditComponent = (function () {
    ...
    AuditoriaDadosEditComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'auditoria-dados-edit', templateUrl: 'auditoria_dadosEdit.component.html' }), 
        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], AuditoriaDadosEditComponent);
    return AuditoriaDadosEditComponent;
}());
exports.AuditoriaDadosEditComponent = AuditoriaDadosEditComponent;
//# sourceMappingURL=auditoria_dadosEdit.component.js.map