...
var Log_documentoDadosDetailsComponent = (function () {
    ...
    Log_documentoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'log_documento-dados-details', templateUrl: 'log_documento_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Log_documentoDadosDetailsComponent);
    return Log_documentoDadosDetailsComponent;
}());
exports.Log_documentoDadosDetailsComponent = Log_documentoDadosDetailsComponent;
//# sourceMappingURL=log_documento_dadosDetails.component.js.map