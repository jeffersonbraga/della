...
var Documento_picDadosDetailsComponent = (function () {
    ...
    Documento_picDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'documento_pic-dados-details', templateUrl: 'documento_pic_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Documento_picDadosDetailsComponent);
    return Documento_picDadosDetailsComponent;
}());
exports.Documento_picDadosDetailsComponent = Documento_picDadosDetailsComponent;
//# sourceMappingURL=documento_pic_dadosDetails.component.js.map