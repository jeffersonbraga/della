...
var Causa_efeitoDadosDetailsComponent = (function () {
    ...
    Causa_efeitoDadosDetailsComponent = __decorate([
        core_1.Component({ moduleId: module.id, selector: 'causa_efeito-dados-details', templateUrl: 'causa_efeito_dadosDetails.component.html' }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, pesquisa_service_1.PesquisaService])
    ], Causa_efeitoDadosDetailsComponent);
    return Causa_efeitoDadosDetailsComponent;
}());
exports.Causa_efeitoDadosDetailsComponent = Causa_efeitoDadosDetailsComponent;
//# sourceMappingURL=causa_efeito_dadosDetails.component.js.map